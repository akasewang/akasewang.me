...
export const landingPageContent: LandingPageContent = {
  hero: {
    ...
    aboutTitle: 'about me.',
    about: [
      `Hey there! I'm a software engineer who likes to [build applications](/projects) that make everyday things a little easier for me and the people around me and design [reusable components](${componentsHref}) for the joy of making things.`,
