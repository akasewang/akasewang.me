...
export function NewTag({ className }: NewTagProps) {
  return (
    ...
    >
      <div className="relative flex items-center overflow-hidden rounded-full bg-gradient-to-b from-verified to-verified-deep py-[1px] pl-4 pr-3 shadow-[inset_0_1px_1px_oklch(100%_0_0/0.2),inset_0_-1px_1px_oklch(0%_0_0/0.1)]">
        <span className="pointer-events-none absolute inset-y-0 left-0 z-0 w-1/2 animate-[shimmer_2s_linear_infinite] bg-gradient-to-r from-transparent via-white/20 to-transparent" />
