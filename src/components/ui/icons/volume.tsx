...
/** The parent replays the waves through this rather than by holding a state of its own */
...
/**
 * The sound toggle. Both waves stay drawn and are only replayed on request, inner first, so the
 * mark reads as sound leaving the speaker.
 */
