...
const TOAST_OPTIONS = {
  ...
  classNames: {
    ...
    actionButton:
      'inline-flex shrink-0 items-center justify-center rounded-md bg-primary px-3 py-1.5 text-[13px] font-medium text-primary-foreground transition-[background-color,box-shadow,transform] supports-hover:hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-toast active:bg-primary/90 active:scale-[0.95]',
    cancelButton:
    ...
    closeButton:
      'absolute right-2.5 top-2.5 flex items-center justify-center rounded-md p-1 text-muted-foreground opacity-0 transition-colors !bg-transparent supports-hover:hover:!bg-muted/50 supports-hover:hover:text-primary focus-visible:opacity-100 supports-hover:group-hover/toast:opacity-100 active:!bg-muted/50 active:text-primary [@media(hover:none)]:opacity-100',
