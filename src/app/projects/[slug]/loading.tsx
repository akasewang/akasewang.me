    ...
    <div className="relative space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2 pt-1">
          <Skeleton className="h-3.5 w-32 rounded bg-surface-20" />
          <Skeleton className="h-3.5 w-20 rounded bg-surface-30" />
        </div>
      ...
      <div className="my-8 w-full">
        <Skeleton className="aspect-video w-full rounded-xl bg-surface-20 ring-1 ring-inset ring-ring/40" />
      </div>
